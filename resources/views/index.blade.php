          ...
          <tr>
            <td align="center" valign="top" style="padding:0 25px;" class="em_aside10"><table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
              ...
              <tr>
                ...
                <img src="https://alumni.unical.edu.ng/images/logo-dark.png" width="15%"  alt="unical_logo" border="0" style="display:block; font-family:Arial, sans-serif; font-size:18px; line-height:25px; text-align:center; color:#1d4685; font-weight:bold; max-width:208px;" class="em_w150" />
            </a></td>
              </tr>
          ...
          <tr>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
              ...
              <tr>
                ...
                University Of Calabar Alumni </td>
              </tr>
              <tr>
              ...
              <tr>
              	<td valign="top" align="left" bgcolor="#ffffff" style="padding-left:25px; padding-right:35px; background-color:#ffffff;" class="em_aside10">
                	<table width="100%" border="0" cellspacing="0" cellpadding="0" align="left">
                      ...
                      <tr>
                        <td class="em_blue em_center" align="left" valign="top" style="font-family: Arial, sans-serif; font-size: 20px; line-height: 24px; color:#264780; font-weight:bold;">
                        Introducing Meowverse</td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        ...
                        We’re excited to announce Meowverse - a place for cat lovers to hang out with other 
                        cat lovers. Kind of like a cat cafe - but with your own cat, at home. 
                        (Okay, it’s nothing like a&nbsp;cat&nbsp;cafe.)
                    </td>
                      </tr>
                      <tr>
                        <td height="8" style="height:8px; font-size:0px; line-height:0px;">&nbsp;</td>
              ...
              <tr>
                <td align="center" valign="top" style="font-size:0px; line-height:0px;"><table border="0" cellspacing="0" cellpadding="0" align="center">
                  <tr>
                    ...
                    <a href="mailto:etim@unical.edu.ng " style="text-decoration:none;color:#434343;">etim@unical.edu.ng </a>,
                    <a href="mailto:graceibor@unical.edu.ng" style="text-decoration:none; color:#434343;">graceibor@unical.edu.ng</a>
                     ,<a href="mailto:annoden@unical.edu.ng" style="text-decoration:none; color:#434343;">annoden@unical.edu.ng</a></td>
                  </tr>
                </table>
                </td>
              </tr>
               ...
               <tr>
                <td align="center" valign="top"><table border="0" cellspacing="0" cellpadding="0" align="center">
                  <tr>
                    ...
                    <td class="em_grey em_font_11" align="left" valign="middle" style="font-family: Arial, sans-serif; font-size: 13px; line-height: 15px; color:#434343;">
                    The University of Calabar Trust and Endowment Fund Limited/Guarantee<br/><br/>
New Senate Chambers Building, University of Calabar, Calabar</td>
                  </tr>
                </table>
                </td>
              </tr>
            ...
            <td align="center" valign="top" style="padding:0 25px;" class="em_aside10"><table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
              ...
              <tr>
                <td align="center" valign="top"><table border="0" cellspacing="0" cellpadding="0" align="left" class="em_wrapper">
                  <tr>
                    <td class="em_grey" align="center" valign="middle" style="font-family: Arial, sans-serif; font-size: 11px; line-height: 16px; color:#434343;">&copy; University Of Calabar Alumni 2022  &nbsp;|&nbsp;  <a href="#" target="_blank" style="text-decoration:underline; color:#434343;">Unsubscribe</a></td>
                  </tr>
                </table>
                </td>
              </tr>
